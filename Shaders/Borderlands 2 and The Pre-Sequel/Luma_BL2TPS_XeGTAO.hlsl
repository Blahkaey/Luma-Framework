...
{
   float4 xe_params0; // intensity, radius fraction, fixed radius, falloff range
   float4 xe_params1; // distribution power, thin occluder compensation, final power, unused
}
...
// BL2/TPS scales its AO radius with view depth.
#define EFFECT_RADIUS_DEPTH_FRACTION xe_params0.y
#define EFFECT_RADIUS                xe_params0.z
